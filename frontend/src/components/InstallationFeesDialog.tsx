...
export default function InstallationFeesDialog({ open, onOpenChange }: InstallationFeesDialogProps) {
  ...
  const fetchFees = async () => {
    try {
      setLoading(true)
      const response = await api.get(endpoints.installationFees.list)
  ...
  const handleCreateFee = async () => {
    ...
    try {
      ...
      const response = await api.post(endpoints.installationFees.create, requestData)
  ...
  const handleUpdateFee = async () => {
    ...
    try {
      ...
      const response = await api.put(endpoints.installationFees.update(editingFee.id.toString()), requestData)
  ...
  const handleDeleteFee = async (fee: InstallationFee) => {
    ...
    try {
      setFormLoading(true)
      const response = await api.delete(endpoints.installationFees.delete(fee.id.toString()))
  ...
  const handleCalculateFee = async () => {
    try {
      ...
      const response = await api.get(endpoints.installationFees.calculate(selectedBillingType) + params)
