...
export function CustomerStatusWidget({
  ...
  const fetchCustomers = async () => {
    try {
      setLoading(true)
      console.log('🔍 CustomerStatusWidget: Fetching customers from:', endpoints.realtime.onlineCustomers)
      ...
      const response = await api.get(endpoints.realtime.onlineCustomers)
