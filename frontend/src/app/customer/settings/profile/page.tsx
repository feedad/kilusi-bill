...
export default function CustomerProfilePage() {
  ...
  const fetchProfileData = async () => {
    try {
      ...
      console.log('🔍 Profile: REAL API Response:', apiResponse)

      if (apiResponse.success && apiResponse.data && apiResponse.data.customer) {
        const realCustomerData = apiResponse.data.customer
        ...
        throw new Error(apiResponse.message || 'Failed to get customer data from database')
      }
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 mt-2">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    {profile.package_name} • {new Intl.NumberFormat('id-ID', {
                      style: 'currency',
                      currency: 'IDR',
