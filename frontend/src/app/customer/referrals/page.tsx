  ...
  const { customer, isAuthenticated } = useCustomerAuth();
    ...
    const fetchReferralData = async () => {
        ...
        try {
            ...
            const codeResponse = await customerAPI.request(
                `/api/v1/customer-referrals/my-code`,
            );
            ...
            const historyResponse = await customerAPI.request(
                `/api/v1/customer-referrals/history`,
            );
    ...
    const shareReferral = async (method: string) => {
        ...
        const referralLink = `https://portal.kilusi.id/register?ref=${referralCode.code}`;
    ...
    const totalReferrals = transactions.filter(
        (t) => t.referrer_id === customer?.id,
    ).length;
    const successfulReferrals = transactions.filter(
        (t) => t.referrer_id === customer?.id && t.status === "applied",
    ).length;
        ...
        <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">
                    Dapatkan reward dengan mengajak teman-teman Anda bergabung
                    dengan layanan kami
                </p>
            </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-white/20 backdrop-blur rounded-lg">
                                        <div>
                                            ...
                                            <div className="text-sm opacity-90">
                                                Digunakan{" "}
                                                {referralCode.usage_count} dari{" "}
                                                {referralCode.max_uses} kali
                                            </div>
                        ...
                        <CardContent>
                            {loading ? (
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <div className="font-medium text-green-600">
                                                            +Rp{" "}
                                                            {transaction.benefit_amount.toLocaleString(
                                                                "id-ID",
                                                            )}
                                                        </div>
                                                    </div>
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Bagikan kode referral Anda kepada
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <Card>
                            ...
                            <CardContent className="text-center">
                                <p className="text-muted-foreground">
                                    Dapatkan potongan tagihan atau cash reward
                                    untuk setiap referral berhasil
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent className="text-center">
                                <p className="text-muted-foreground">
                                    Cukup bagikan kode referral Anda dan teman
                                    tinggal memasukkannya saat registrasi
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent className="text-center">
                                <p className="text-muted-foreground">
                                    Referensikan sebanyak mungkin teman dan
                                    kumpulkan reward terus menerus
                                </p>
                            </CardContent>
                        </Card>
                    </div>
                        ...
                        <CardContent>
                            <div className="text-center py-8">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="p-4 border-2 border-green-200 rounded-lg bg-green-50 max-w-md mx-auto">
                                        ...
                                        <div className="text-xs text-green-600 mt-1">
                                            Hanya untuk pelanggan aktif yang
                                            memiliki portal
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p className="text-muted-foreground mb-4">
                                    Login untuk mulai mendapatkan kode referral
                                    Anda
                                </p>
                                <Button
                                    onClick={() =>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                <h4 className="font-semibold mb-2">
                                    Berapa reward yang saya dapatkan?
                                </h4>
                                <p className="text-sm text-muted-foreground">
                                    Sebagai pelanggan aktif, Anda akan
                                    mendapatkan{" "}
                                    <strong>potongan tagihan Rp 25.000</strong>{" "}
                                    untuk setiap referral berhasil. Reward
                                    otomatis diterapkan ke tagihan bulanan Anda
                                    setelah referred customer aktif 1 bulan.
                                </p>
                            </div>

                            <div>
                                <h4 className="font-semibold mb-2">
                                    Kapan saya mendapatkan reward?
                                </h4>
                                <p className="text-sm text-muted-foreground">
                                    Reward akan diberikan setelah pelanggan yang
                                    direferensikan aktif selama 1 bulan dan
                            ...
                            <div>
                                <h4 className="font-semibold mb-2">
                                    Bagaimana dengan non-pelanggan yang
                                    mereferensikan?
                                </h4>
                                <p className="text-sm text-muted-foreground">
                                    Untuk marketer atau non-pelanggan yang
                                    mereferensikan customer baru, sistem akan
                                    memberikan{" "}
                                    <strong>cash reward Rp 30.000</strong>. Ini
                                    berlaku otomatis berdasarkan status pengaju
                                    di sistem.
                                </p>
                            </div>
                            ...
                            <div>
                                <h4 className="font-semibold mb-2">
                                    Ada berapa jenis kode referral?
                                </h4>
                                <p className="text-sm text-muted-foreground">
                                ...
                                <ul className="text-sm text-muted-foreground mt-2 ml-4 list-disc">
                                    <li>
                                        <strong>Kode Pribadi</strong> - Generate
                                        otomatis untuk setiap pelanggan aktif
                                        (contoh: REF7X9Y2Z)
                                    </li>
                                    <li>
                                        <strong>Kode Marketing</strong> - Kode
                                        tetap untuk campaign marketing (contoh:
                                        KILUSI2025)
                                    </li>
                                </ul>
                                <p className="text-sm text-muted-foreground mt-2">
                                    Keduanya memberikan benefit yang sama untuk
                                    yang direferensikan!
                                </p>
                            </div>
                            ...
                            <div>
                                <h4 className="font-semibold mb-2">
                                    Apakah ada batas penggunaan kode referral?
                                </h4>
                                <p className="text-sm text-muted-foreground">
                                    Setiap kode referral memiliki batas
                                    penggunaan dan masa berlaku tertentu.
                                    Defaultnya adalah 50 penggunaan dalam 1
                                    tahun.
                                </p>
                            </div>
                        </CardContent>
