              ...
              <div className="space-y-4">
                {filteredTickets.map((ticket) => (
                  <div
                    ...
                    onClick={() => window.location.href = `/customer/support/tickets/${ticket.id}`}
                  >
                      ...
                      <div className="flex flex-col items-end gap-2">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              window.location.href = `/customer/support/tickets/${ticket.id}`
                            }}
                          >
                          ...
                          {ticket.status === 'open' && (
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                window.location.href = `/customer/support/tickets/${ticket.id}?reply=true`
                              }}
                            >
