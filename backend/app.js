...
const defaultOrigins = [
    ...
    'http://127.0.0.1:3001',
    'http://127.0.0.1:3002',
    'http://172.22.10.31:3000',  // Network IP for Next.js frontend
    'http://172.22.10.31:3001',  // Network IP for Next.js dev frontend
    'http://172.22.10.31:3002',  // Network IP for Next.js dev frontend
...
// Mount admin routes - authRouter should be first
app.use('/admin', adminAuthRouter);
app.use('/admin', adminODPRouter);
app.use('/admin', adminAuth, adminDashboardRouter);
...
// Import dan gunakan WhatsApp Cloud API webhook (removed - now using functions only)

// Log WhatsApp Cloud API integration
...
function startServer(portToUse) {
    ...
    try {
        ...
        server.listen(port, host, () => {
            ...
            logger.info(`🌐 Web Portal tersedia di: http://${host === '0.0.0.0' ? '172.22.10.31' : host}:${port}`);
            logger.info(`🌐 Local access: http://localhost:${port}`);
            logger.info(`🌐 Network access: http://172.22.10.31:${port}`);
            logger.info(`🌐 WebSocket available: ws://${host === '0.0.0.0' ? '172.22.10.31' : host}:${port}`);
