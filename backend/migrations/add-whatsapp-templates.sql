-- WhatsApp Templates for KilusiBill
-- This file contains all WhatsApp notification templates

-- 1. Registration Rejected Template
...
-- 2. Service Restoration Template
INSERT INTO whatsapp_templates (template_id, name, category, content, variables, enabled)
VALUES (
    'service_restoration',
...
-- 3. Ticket Assigned to Technician Template
INSERT INTO whatsapp_templates (template_id, name, category, content, variables, enabled)
VALUES (
    'ticket_assigned',
...
-- 4. Technician New Installation Task Template
INSERT INTO whatsapp_templates (template_id, name, category, content, variables, enabled)
VALUES (
...
-- 5. Admin New Registration Notification Template
INSERT INTO whatsapp_templates (template_id, name, category, content, variables, enabled)
VALUES (
...
-- 6. Technician Ticket Resolved (Customer Notification)
INSERT INTO whatsapp_templates (template_id, name, category, content, variables, enabled)
VALUES (
...
-- Verify templates
SELECT template_id, name, category, enabled
